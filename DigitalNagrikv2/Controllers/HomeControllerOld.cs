...
//                    Responseaadhar objResponseFirst = Newtonsoft.Json.JsonConvert.DeserializeObject<Responseaadhar>(result);
//                    objcm.AadharVerificationLog("requestauth", result);
...
//                            reqaadhaarOTP.otpMedium = "01";
//                            string dataOTP = Newtonsoft.Json.JsonConvert.SerializeObject(reqaadhaarOTP);
//                            string jsonStringOTPenc = EncryptDencrypt.Encrypt(dataOTP, "df0025ae-77d8-4806-aa72-ee7610b00bf5");
...
//                            wc = new WebClient();
//                            wc.Headers[HttpRequestHeader.ContentType] = "application/json";
//                            result = wc.UploadString("https://authenticate.epramaan.gov.in/authwebservice/requestaadhaarotpauth", finaldataOTP);
//                            Responseaadhar objResponseFirstOTP = Newtonsoft.Json.JsonConvert.DeserializeObject<Responseaadhar>(result);
...
//                    objcm.AadharVerificationLog("verifyaadhaarotpauth", result);
//                    Responseaadhar objResponseFirst = Newtonsoft.Json.JsonConvert.DeserializeObject<Responseaadhar>(result);
//                    if ((objResponseFirst.status == null ? "" : objResponseFirst.status) == "true")
//                    {
//                        objcm.CreateUser(Session["CitizenEmailMobile"].ToString());
