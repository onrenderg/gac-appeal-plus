...
namespace GACAppeal
{	
	public partial class NotAdmittedPage : ContentPage
	{	
		public NotAdmittedPage ()
		{
			InitializeComponent ();
            ...
            else
            {
                ...
                Lbl_NoRecord.Text = "No Not Admitted Appeal Found";
        ...
        void FillLable()
        {
            ...
            Lbl_Title.Text = $"{App.LableValueGeneric("Appeal")} - {App.LableValueGeneric("NotAdmitted")}\n{App.listCitizenProfile.First().FirstName} {App.listCitizenProfile.First().MiddleName} {App.listCitizenProfile.First().LastName} ({App.listCitizenProfile.First().UserMobile})";// \n{App.listCitizenProfile.First().UserMobile}
            Page_name.Title = App.LableValueGeneric("NotAdmitted");
        }
